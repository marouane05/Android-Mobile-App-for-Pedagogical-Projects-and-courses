...
class SemestreLicence : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_semestre_licence)
        ...
        var description_projet : String=intent.getStringExtra("desc")
...
for(j in 0 until maList.size ){
           ...
           /*     if(id_cycle==1){
                ...
                val intent = Intent(applicationContext, SemestreLicenceDeux::class.java)
                intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK
                intent.putExtra("id", id_projet)
                intent.putExtra("module1",module1.text.toString())
                intent.putExtra("module2",module2.text.toString())
                intent.putExtra("module3",module3.text.toString())
                intent.putExtra("module4",module4.text.toString())
                intent.putExtra("module5",module5.text.toString())
                intent.putExtra("module6",module6.text.toString())

                intent.putExtra("heure1",heure1.text.toString())
                intent.putExtra("heure2",heure2.text.toString())
                intent.putExtra("heure3",heure3.text.toString())
                intent.putExtra("heure4",heure4.text.toString())
                intent.putExtra("heure5",heure5.text.toString())
                intent.putExtra("heure6",heure6.text.toString())
