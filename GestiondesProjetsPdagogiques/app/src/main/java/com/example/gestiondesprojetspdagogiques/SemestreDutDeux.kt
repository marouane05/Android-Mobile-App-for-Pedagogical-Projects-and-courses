...
class SemestreDutDeux : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_semestre_dut_deux)
        ...
        module7 = this.findViewById(R.id.module5)
        module8 = this.findViewById(R.id.module6)
